...
const WorkspaceProvider = ({ children }: { children: React.ReactElement }) => {
  ...
  const [notes, setNotes] = useState<WidgetItem[]>(window.marqueeStateConfiguration['@vscode-marquee/notes-widget'].state.notes);
  const [todos, setTodos] = useState<WidgetItem[]>(window.marqueeStateConfiguration['@vscode-marquee/todo-widget'].state.todos);
  const [snippets, setSnippets] = useState<WidgetItem[]>(window.marqueeStateConfiguration['@vscode-marquee/snippets-widget'].state.snippets);
